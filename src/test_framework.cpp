...
//     std::cout << std::left << std::setw(6) << "Idx" << std::setw(8) << "G1_S" << std::setw(8) << "G2_S" <<
//     std::setw(8)
...
//
//         std::cout << std::left << std::setw(6) << idx++ << std::setw(8) << spec.size_g1 << std::setw(8) <<
//         spec.size_g2
//                   << std::setw(8) << std::fixed << std::setprecision(1) << spec.density_g1 << std::setw(8) <<
//                   std::fixed
...
//                   << precise_time.count() << std::setw(20) << std::fixed << std::setprecision(3) <<
//                   approx_time.count()
//                   << "\n";
//     }
//     std::cout << std::string(140, '-') << "\n";
...
// {
//     RunTest_(
//         PreciseSpec, kPreciseAlgos[static_cast<size_t>(precise_algo)],
//         kPreciseAlgos[static_cast<size_t>(precise_algo1)]
//     );
// }
//
// // ------------------------------
